  ...
  return (
    <div className="max-w-7xl mx-auto py-20 md:py-32 px-4 md:px-0">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20 items-center">
        {/* Profile image */}
        <div className="reveal reveal-left lg:col-span-5 xl:col-span-4 relative group max-w-xs sm:max-w-sm mx-auto lg:mx-0 w-full">
        ...
        {/* Text Content */}
        <div className="reveal reveal-right lg:col-span-7 xl:col-span-8 space-y-8 md:space-y-10">
          <div>
            ...
            <p className="text-white/60 text-base md:text-xl leading-relaxed mb-6">
              I am Oluwagbotemi Olatunji, a dedicated software engineer specializing in
              building modern, scalable web applications. My approach focuses on creating
              robust backend systems paired with elegant, user-centric frontends.
            </p>
            <p className="text-white/60 text-base md:text-xl leading-relaxed">
              With a background in system architecture and a passion for clean code, I
              craft digital experiences that are not only functional but visually
              stunning. I'm driven by the challenge of turning complex problems into
