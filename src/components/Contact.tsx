...
const Contact: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-40 text-center">
      <span className="reveal reveal-left font-mono text-primary text-sm tracking-[0.3em] uppercase mb-6 block">&lt;Contact /&gt;</span>
      <h2 className="reveal reveal-right text-6xl md:text-8xl font-black mb-10 tracking-tighter">LET'S BUILD <br /> THE FUTURE.</h2>
      ...
      <a 
        ...
        className="reveal reveal-left inline-block glass px-16 py-8 rounded-3xl text-2xl md:text-3xl font-black hover:bg-primary hover:text-background-dark transition-all duration-500 border border-white/10 group overflow-hidden relative shadow-2xl"
      >
